		...
		<Paper withBorder p="md" radius="md" mt="md">
			...
			<Accordion>
				<Accordion.Item value="claustrophobia">
					...
					<Accordion.Panel>
						<Text>
							Good news! Our beginner trips only visit caves with spacious
							passages. Many of the main chambers are so large you could park
							several cars inside them! Think of it like walking through a
							natural underground cathedral rather than squeezing through tight
							spaces. Most beginners are surprised by how open and comfortable
							these introductory caves feel - more like exploring an interesting
				...
				<Accordion.Item value="dark">
					...
					<Accordion.Panel>
						<Text>
							...
							high-quality LED headlamps that cast impressive beams, and guides
							...
							amazed by how clearly they can see everything - it's more like a
							stunning light show than true darkness!
						</Text>
					</Accordion.Panel>
				</Accordion.Item>
				...
				<Accordion.Item value="stuck">
					...
					<Accordion.Panel>
						<Text>
							...
							whatsoever. Our experienced guides have taken hundreds of people
				...
				<Accordion.Item value="falling">
					...
					<Accordion.Panel>
						<Text>
							...
							there's no loose scree or slippery pine needles, just solid rock
							with plenty of natural handholds. Our guides always point out the
				...
				<Accordion.Item value="lost">
					...
					<Accordion.Panel>
						<Text>
							...
							have traversed countless times. We use a tried-and-tested buddy
							system and maintain constant communication throughout the group.
							Our guides are professionally trained in cave navigation and carry
							multiple backup light sources and emergency equipment. You can
							simply relax and enjoy the experience while we handle all the
							navigation!
						</Text>
					</Accordion.Panel>
				</Accordion.Item>
				...
				<Accordion.Item value="fitness">
					...
					<Accordion.Panel>
						<Text>
							...
							average fitness levels. If you can climb a flight of stairs and
							walk for about 30 minutes, you'll do great! We take a gentle pace
							with regular rest stops to admire the cave features. Many
							participants tell us it's less physically demanding than they
							expected - more like a leisurely nature walk with a few moments of
							gentle adventure!
						</Text>
					</Accordion.Panel>
				</Accordion.Item>
				...
				<Accordion.Item value="dirty">
					...
					<Accordion.Panel>
						<Text>
							...
							oversuits that keep your clothes completely clean underneath. Many
				...
				<Accordion.Item value="equipment">
					...
					<Accordion.Panel>
						<Text>
							We provide absolutely everything you need - high-quality helmets,
							reliable lighting systems, protective clothing, and appropriate
							footwear if needed. Our equipment is professionally maintained,
							regularly inspected, and adheres to British Caving Association
							standards. Before entering the cave, our guides ensure everyone's
				...
				<Accordion.Item value="danger">
					...
					<Accordion.Panel>
						...
						<Text mt="xs">
							What we're offering is essentially the equivalent of a gentle
							underground walk. We follow established pathways, use professional
							equipment, and maintain constant supervision. Our beginner routes
							have been carefully selected for their accessibility and safety.
						</Text>
						<Text mt="xs">
							This experience is so accessible that we've successfully guided
							people in their seventies through these caves on their very first
							caving adventure! We regularly introduce both 18-year-olds just
							starting their adventure journey and older adults looking for
							something new and exciting.
						</Text>
						<Text mt="xs">
							Our perfect safety record speaks for itself. Every guide is fully
							certified, carries emergency equipment, and has completed
							extensive safety training. We follow strict protocols established
							by the British Caving Association, including regular route
							assessments, equipment checks, and maintaining appropriate
