				...
				<Box>
					<Group gap="xs" align="flex-start">
						...
						<div>
							<Text>
								Estimated Duration:{" "}
								{Number.parseFloat(estimatedTime) +
									Number.parseFloat(estimatedTime) * 0.25}{" "}
								hours
							</Text>
										...
										>
											<Text size="sm">
												...
												<List size="sm" mt="xs">
													...
													<List.Item>
														Following instructions from leaders and being
														supportive around other cavers
													</List.Item>
												</List>
											</Text>
										</Alert>
								...
								<Box>
									<Alert color="teal" icon={<IconCompass size={18} />} mb="md">
										<Text size="sm">
											...
											<List size="sm" mt="xs">
												<List.Item>
													Be able to walk up two flights of stairs unaided
												</List.Item>
												<List.Item>Be able to bend down and kneel up</List.Item>
												<List.Item>Be able to laugh</List.Item>
												<List.Item>
													Be willing to support other people in the group
												</List.Item>
											</List>
										</Text>
									</Alert>
						...
						{participantSkills?.recommended_training &&
							participantSkills.recommended_training.length > 0 && (
								<div>
									...
									<List>
										{participantSkills.recommended_training.map(
											(training, i) => (
												<List.Item
						...
						{hasExperienceData && !isPastTrip && (
							...
							>
								<Text size="sm">
									...
									formations or removing any historical relics. Take nothing but
								...
								<Alert color="blue" icon={<IconInfoCircle size={16} />}>
									<Text size="sm">
										...
										(Array.isArray(personalGear) &&
											...
											<>
												<strong>Important:</strong> This trip requires you bring
												your own gear. The Crew can't offer you gear for this
												trip - usually because its already in use.
											</>
										) : (
											<>
												Don't have any of the gear? The Crew has all equipment
												available to borrow - just let us know what you already
												have after you sign up.
											</>
										)}
									</Text>
								</Alert>
						...
						{groupTackle && (
							<Stack gap="md" mb="xl">
								...
								<Alert color="violet" icon={<IconInfoCircle size={16} />}>
									<Text size="sm">
										The trip leader will organize this equipment. You don't need
										to bring these items unless specifically asked.
									</Text>
								</Alert>
							</Stack>
						)}
